...
class TypescriptGenerator(
    ...
    fun generate(
        ...
        val customTypes = filterTypesForGeneration(findAllUsedTypes(types + exportTypescriptTypes))
        val rootNamespace = buildNamespaceTree("", customTypes)
        val typesOriginatingFiles = customTypes.mapNotNull { it.containingFile }

        createTypescriptModelsFile(
            rootNamespace,
            rnModulesOriginatingFiles + typesOriginatingFiles
        )

        createRNModulesFile(rnModules, rnModulesOriginatingFiles)
    }

    private fun createTypescriptModelsFile(
        rootNamespace: NamespaceNode,
