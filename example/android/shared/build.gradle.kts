    ...
    sourceSets {
        ...
        val commonMain by getting {
            dependencies {
                ...
                implementation("de.voize:reakt-native-toolkit:0.2.0") {
...
dependencies {
    add("kspAndroid", "de.voize:reakt-native-toolkit-ksp:0.2.0")
    add("kspIosX64", "de.voize:reakt-native-toolkit-ksp:0.2.0")
    add("kspIosArm64", "de.voize:reakt-native-toolkit-ksp:0.2.0")
}
